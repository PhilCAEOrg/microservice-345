 ...
 * 345 - Test Class
 *
 * This class provides a basic testing framework for the microservice 345. It was
...
public class ResourceTest {
  ...
  /**
   * 
   * Test for the resmethod method.
   * 
   */
  @Test
  public void testresmethod() {
    MiniClient c = new MiniClient();
    c.setAddressPort(HTTP_ADDRESS, HTTP_PORT);
    try {
      JSONObject payload = new JSONObject();
      c.setLogin(testAgent.getIdentifier(), testPass);
      ClientResponse result = c.sendRequest("GET", mainPath + "/resmethod", payload.toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testresmethod': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
