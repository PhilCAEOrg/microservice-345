...
public class Resource extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "345", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-345/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiOperation(value = "resmethod", notes = " ")
  public Response resmethod(String payload) {
